...
ActiveRecord::Schema[7.0].define(version: 2023_03_07_105925) do
  ...
  create_table "shoppings", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["product_it_id"], name: "index_shoppings_on_product_it_id"
    t.index ["user_id_id"], name: "index_shoppings_on_user_id_id"
  end
  ...
  add_foreign_key "shoppings", "product_its"
  add_foreign_key "shoppings", "user_ids"
end
